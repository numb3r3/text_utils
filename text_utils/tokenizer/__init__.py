...
class Tokenizer:
    ...
    def _load(self, model_path=None):
        ...
        if not model_path:
            ...
            self._jieba.load_userdict(
                os.path.join(model_path, "user_dict.txt"))
        self._is_init = True
...
if __name__ == '__main__':
    ...
    res = tokenizer.tokenize(
        u"据美国《侨报》报道，近日，美国各大高校纷纷迎来毕业典礼，又有一批中国留学生将迎来一次人生转折的抉择：回国就业还是留美打拼？走向社会还是留校深造？这些问题几乎是所有留学生在毕业季都要面临的困扰。"
    )
    print(res)
